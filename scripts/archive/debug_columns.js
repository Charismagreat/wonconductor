...
async function test() {
    ...
    try {
        ...
        await executeSQL("SELECT id FROM report_row LIMIT 1");
        console.log("id OK");

        console.log("SELECT data...");
        await executeSQL("SELECT data FROM report_row LIMIT 1");
        console.log("data OK");

        console.log("SELECT createdAt...");
        await executeSQL("SELECT createdAt FROM report_row LIMIT 1");
