...
async function testInsert() {
    try {
        console.log('--- Testing "report" insertion WITHOUT ID ---');
        const body = JSON.stringify({
            ...
            arguments: {
                ...
                rows: [{
                    // id is OMITTED
                    name: 'Auto-ID Test Report',
                    tableName: 'test_table_auto',
                    columns: '[]',
                    ownerId: 'system',
        ...
        if (result.success) {
            ...
            console.log('Inserted Content Details:', JSON.stringify(content, null, 2));
        }
